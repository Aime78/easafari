...
const ProviderExperienceTable = ({
  experiences,
  selectedCategory,
}: ProviderExperienceTableProps) => {
          ...
          <div className="flex gap-2">
            ...
            {selectedCategory && !searchTerm.trim() && (
              <Button
                variant="outline"
                size="sm"
                // onClick={() => navigate('/provider/experiences')}
              >
  ...
  return (
    <Card className="p-6 border-none shadow-none">
      ...
      {/* Delete Dialog */}
      {experienceToDelete && (
        <DeleteProviderExperienceDialog
...
export default ProviderExperienceTable;
