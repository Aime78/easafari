        ...
        <p className="text-gray-500 text-center max-w-sm mb-6">
          {isFiltered ? (
            searchTerm.trim() ? (
              selectedCategory ? (
                <>
                  No attractions in {selectedCategory.name} match "{searchTerm}
                  ". Try different keywords or browse other categories.
                </>
              ) : (
                <>
                  No attractions match your search "{searchTerm}". Try different
                  keywords or browse categories.
                </>
              )
            ) : (
              <>
                No attractions found in {selectedCategory?.name}. Try browsing
                other categories.
              </>
            )
          ) : (
